...
export const DateTimeDisplay = ({ date, time }: Props) => (
  <div className="hidden md:flex bg-ui-inner/40 items-center gap-3 text-ui-text px-8 h-9 rounded-xl tabular-nums font-bold backdrop-blur-2xl transition-colors duration-300">
