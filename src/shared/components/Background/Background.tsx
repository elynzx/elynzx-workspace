...
export const Background = () => {
  ...
  return (
    <div className="fixed inset-0 -z-10 overflow-hidden pointer-events-none bg-[#030014]">
      ...
      <div className="absolute inset-0 bg-white/[0.01] backdrop-blur-[2px] before:absolute before:inset-0 before:bg-gradient-to-tr before:from-transparent before:via-white/[0.02] before:to-pink-400/[0.03]" />
